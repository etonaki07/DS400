...
1.  Why is the Poisson model a reasonable choice for our data Yi?
    ...
    -   This is count data so it fits in data type for Poisson model.

    -   This generally fits our prior understanding of how many goals can be scored in a soccer game.
...
```{r}
summarize_gamma_poisson(1, 0.25, sum_y = 146, n = 52)
```

```{r}
plot_gamma_poisson(1, 0.25, sum_y = 146, n = 52)
```
